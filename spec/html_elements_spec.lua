...
describe("HTML elements", function()
    ...
    describe("A", function()
        ...
        it("should render an anchor tag with href and text", function()
            ...
            local a = A(nil, { "Google" }):addAttribute({ href = link })
    ...
    describe("Attribute Setting", function()
        describe("Container Elements", function()
            it("should set attributes using a list of strings", function()
                local div = Div({ "class='test-class'", "id='test-id'" })
                assert.are.equal("<div class='test-class' id='test-id'></div>", div:render())
            end)

            it("should set attributes using an associative array (table)", function()
                local div = Div({ class = "another-class" })
                assert.are.equal("<div class='another-class'></div>", div:render())
            end)
        end)

        describe("Void Elements", function()
            it("should set attributes using a list of strings", function()
                local img = Img({ "src='image.jpg'", "alt='Test Image'" })
                assert.are.equal("<img src='image.jpg' alt='Test Image'>", img:render())
            end)

            it("should set attributes using an associative array (table)", function()
                local img = Img({ src = "image2.png" })
                assert.are.equal("<img src='image2.png'>", img:render())
            end)
        end)
    end)
end)
